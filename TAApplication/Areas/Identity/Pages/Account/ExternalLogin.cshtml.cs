...
/**
  ...
  File Contents:
     Takes information from the view and creates the user in the database
*/
...
Description = "Please enter your unID")]
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            {
                // Data is in the identity's claims
                ClaimsIdentity googleuser = info.Principal.Identities.First();
                var googleData = googleuser.Claims.ToArray();
                // [2] = givenname, [3] = surname
                var user = new TAUser { UserName = Input.Email, Email = Input.Email, Unid = Input.Unid, FirstName = googleData[2].Value, LastName = googleData[3].Value };
